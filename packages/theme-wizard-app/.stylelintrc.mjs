export default {
  ...
  ignoreFiles: ['**/*', '!**/*.ts'],
  rules: {
    'custom-property-pattern': '^_?(ams|basis|theme|denhaag|utrecht|todo|ma|wizard|nl|clippy)-[a-z0-9-]+$',
    ...
    'selector-class-pattern': '^(ams|basis|theme|denhaag|utrecht|todo|ma|wizard|nl|clippy)-[a-z0-9_-]+$',
  },
  overrides: [
    {
