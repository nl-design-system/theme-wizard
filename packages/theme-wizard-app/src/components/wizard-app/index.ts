...
export class App extends LitElement {
  ...
  readonly #applyComboboxUpdate = (target: ClippyTokenCombobox) => {
   ...
   * - `ClippyTokenCombobox`: updates one token from a selected token reference
  ...
  readonly #handleTokenChange = async (event: Event) => {
    ...
    const hasChanges =
      target instanceof WizardColorscaleInput
        ...
        : target instanceof ClippyTokenCombobox
