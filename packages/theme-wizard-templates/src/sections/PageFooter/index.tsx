...
import { LinkList, Image, PageContent } from '@utrecht/component-library-react/dist/css-module';
...
const PageFooterSection = ({ children }: PropsWithChildren<PageFooterProps>) => (
  <PageFooter>
